...
// Public preview page for viewing a shared resume without opening the editor.
const Preview = () => {
  ...
  const loadResume = async () => {
    try {
      ...
      // Flatten resumeData nested object (same as ResumeBuilder does)
      const flat = { ...resume, ...(resume.resumeData || {}) }
      setResumeData(flat)
    } catch (error) {
      console.log('Resume not found:', error.message)
      setResumeData(null)
    } finally {
      setIsLoading(false)
    }
