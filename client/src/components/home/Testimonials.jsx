    ...
    const cardsData = [
        {
            ...
            date: "April 20, 2026",
            review:
                "I landed three interview calls within a week after updating my resume with this builder. The ATS-friendly format really helped."
        },
        {
            ...
            date: "May 10, 2026",
            review:
                "The AI suggestions improved my resume content and highlighted achievements I would have otherwise missed."
        },
        {
            ...
            date: "June 5, 2026",
            review:
                "Creating a professional resume used to take hours. With this tool, I built a polished resume in less than 15 minutes."
        },
        {
            ...
            date: "June 18, 2026",
            review:
                "The templates are modern, clean, and recruiter-friendly. I received positive feedback during multiple interviews."
        }
    ];

    // Small card component used twice by the marquee rows below.
    const CreateCard = ({ card }) => (
        <div className="soft-card p-4 rounded-lg mx-4 w-72 shrink-0">
            ...
            <p className="text-sm py-4 text-gray-800 dark:text-slate-200">{card.review}</p>
            <div className="flex items-center justify-between text-slate-500 text-xs dark:text-slate-400">
                <div className="flex items-center gap-1">
                    <span>Posted on</span>
    ...
    return (
        <>
            ...
            <div className="marquee-row w-full mx-auto max-w-5xl overflow-hidden relative">
                <div className="absolute left-0 top-0 h-full w-20 z-10 pointer-events-none bg-gradient-to-r from-slate-50 to-transparent dark:from-slate-950"></div>
                <div className="marquee-inner flex transform-gpu min-w-[200%] pt-10 pb-5">
                    {[...cardsData, ...cardsData].map((card, index) => (
                        <CreateCard key={index} card={card} />
                    ))}
                </div>
                <div className="absolute right-0 top-0 h-full w-20 md:w-40 z-10 pointer-events-none bg-gradient-to-l from-slate-50 to-transparent dark:from-slate-950"></div>
            </div>
